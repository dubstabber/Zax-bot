...
def write_static_from_config(section, scratch_off, layout):
    ...
    write_static_scratch_data(
        ...
        wp_lvl2_radius_sq=cfg.WP_LVL2_RADIUS_SQ,
        wp_lvl3_radius_sq=cfg.WP_LVL3_RADIUS_SQ,
        wp_lvl2_offset_max=cfg.WP_LVL2_OFFSET_MAX,
        wp_lvl3_offset_max=cfg.WP_LVL3_OFFSET_MAX,
